    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                'id' => 62,
                'data_type_id' => 8,
                'field' => 'exercise_column_passing_belongsto_choice_relationship',
                'type' => 'relationship',
                'display_name' => 'Choice',
                'required' => 1,
                'browse' => 1,
            ...
            array (
                'id' => 63,
                'data_type_id' => 8,
                'field' => 'exercise_column_passing_belongsto_exercise_column_relationship',
                'type' => 'relationship',
                'display_name' => 'Column',
                'required' => 1,
                'browse' => 1,
            ...
            array (
                'id' => 71,
                'data_type_id' => 9,
                'field' => 'exercise_passing_belongsto_exercise_relationship',
                'type' => 'relationship',
                'display_name' => 'Exercise',
                'required' => 1,
                'browse' => 1,
            ...
            array (
                'id' => 72,
                'data_type_id' => 9,
                'field' => 'exercise_passing_belongsto_user_relationship',
                'type' => 'relationship',
                'display_name' => 'User',
                'required' => 1,
                'browse' => 1,
                ...
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\User","table":"users","type":"belongsTo","column":"exercise_id","key":"id","label":"email","pivot_table":"categories","pivot":"0","taggable":"0"}',
                'order' => 9,
            ),
        ));
